...
if(!isset($_SESSION['user_id'])){
    header("Location: ../html/user_login_page.php");
    exit;
}
...
if(!$user){
    header("Location: ../html/user_register_page.php");
    exit;
}
?>
<!DOCTYPE html>
...
>>>>>>> Stashed changes
        ...
        <div id="main">
            ...
            <div class="user">
                <img src="../<?= htmlspecialchars($user['user_img']) ?>" alt="User Image" style="max-width:100px; max-height:100px;">
           </div>
        </div>
